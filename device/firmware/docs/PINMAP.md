...
| 휠스피드센서 ×4 (RR/RL/FR/FL) | GPIO In | 11–14 | 펄스·온오프 |
...
|-------------|-----------|-------------|
| 휠스피드센서 RR | 디지털 입력 DIN1 | GPIO11 |
| 휠스피드센서 RL | 디지털 입력 DIN2 | GPIO12 |
| 휠스피드센서 FR | 디지털 입력 DIN3 | GPIO13 |
| 휠스피드센서 FL | 디지털 입력 DIN4 | GPIO14 |
...
| 11 | GPIO In (ISR)   | DIN1      | 휠스피드센서 RR (뒤 오른쪽) | `main/peripheral/digital.c:19,36` |
| 12 | GPIO In (ISR)   | DIN2      | 휠스피드센서 RL (뒤 왼쪽)   | `main/peripheral/digital.c:19,37` |
| 13 | GPIO In (ISR)   | DIN3      | 휠스피드센서 FR (앞 오른쪽) | `main/peripheral/digital.c:19,38` |
| 14 | GPIO In (ISR)   | DIN4      | 휠스피드센서 FL (앞 왼쪽)   | `main/peripheral/digital.c:19,39` |
...
| GPIO | 신호 | 모드 | 정의 위치 |
|:----:|------|------|-----------|
| 11 | DIN1 (RR) | Input + ISR (pull-down) | `main/peripheral/digital.c:19,36` |
| 12 | DIN2 (RL) | Input + ISR (pull-down) | `main/peripheral/digital.c:19,37` |
| 13 | DIN3 (FR) | Input + ISR (pull-down) | `main/peripheral/digital.c:19,38` |
| 14 | DIN4 (FL) | Input + ISR (pull-down) | `main/peripheral/digital.c:19,39` |

- 휠스피드센서 4개(RR/RL/FR/FL)가 여기에 연결됩니다.
