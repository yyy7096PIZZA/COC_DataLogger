...
| 11 | DIN1 디지털 입력 (ISR) — 휠스피드 RR | 사용중 | pull-down + ANYEDGE | `main/peripheral/digital.c:19,36` |
| 12 | DIN2 디지털 입력 (ISR) — 휠스피드 RL | 사용중 | | `main/peripheral/digital.c:19,37` |
| 13 | DIN3 디지털 입력 (ISR) — 휠스피드 FR | 사용중 | | `main/peripheral/digital.c:19,38` |
| 14 | DIN4 디지털 입력 (ISR) — 휠스피드 FL | 사용중 | | `main/peripheral/digital.c:19,39` |
...
| 휠스피드센서 ×4 (RR/RL/FR/FL) | 11–14 | 펄스·온오프 |
...
| 사용자 센서 | GPIO / 채널 |
|-------------|-------------|
| 휠스피드센서 RR | DIN1 = GPIO11 |
| 휠스피드센서 RL | DIN2 = GPIO12 |
| 휠스피드센서 FR | DIN3 = GPIO13 |
| 휠스피드센서 FL | DIN4 = GPIO14 |
